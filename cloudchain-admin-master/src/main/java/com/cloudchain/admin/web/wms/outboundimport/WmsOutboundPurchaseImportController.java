 ...
 * 采购退货出库单
 */
@Api(value = "wms-outbound-purchase-import-api", description = "出库单导入接口-采购退货出库单")
@Controller
@RequestMapping("/wmsOutboundPurchaseImport")
public class WmsOutboundPurchaseImportController extends ImpExpController<WmsOutboundRequest, WmsOutboundResponse> {
	private static final Logger logger = LoggerFactory.getLogger(WmsOutboundPurchaseImportController.class);
