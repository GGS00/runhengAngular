 ...
 * 质押出库单
 */
@Api(value = "wms-outbound-impawn-import-api", description = "出库单导入接口-质押出库单")
@Controller
@RequestMapping("/wmsOutboundImpawnImport")
public class WmsOutboundImpawnImportController extends ImpExpController<WmsOutboundRequest, WmsOutboundResponse> {
	private static final Logger logger = LoggerFactory.getLogger(WmsOutboundImpawnImportController.class);
