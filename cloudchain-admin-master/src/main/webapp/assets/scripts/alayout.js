...
var Layout = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed')) {
                ...
                if (App.getViewPort().width < resBreakpointMd) {
                    ...
                    height = $('.right-sidebar-menu').height() + 20;
                }
    ...
    var handleSidebarMenu = function () {
        ...
        $('.left-sidebar-menu').on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {
            var body = $('body');
            var sidebar = $('.left-sidebar');
            var sidebarMenu = $('.left-sidebar-menu');
        ...
        $('.extra-sidebar').on('click', 'li > a.nav-toggle, li > a > span.nav-toggle', function (e) {
            var body = $('body');
            var sidebar = $('.left-sidebar');
            var sidebarMenu = $('.left-sidebar-menu');
            var that = $(this).closest('.nav-item').children('.nav-link');
    ...
    var handleSidebarToggler = function () {
        ...
        $('body').on('click', '.sidebar-toggler-menu', function (e) {
