 ...
 * 入库单控制器
 */
angular.module('MetronicApp').controller('editCustomerController', function ($rootScope, $scope, $http,$location, uiGridConstants, settings, editCustomer, commonUtil, Table) {
    ...
    editCustomer.getDetail(vm).success(function (data) {
        vm.data=data;
    });
    /*********** **************************************************修改贷款规则************************************************************************************/
    vm.editCustomer =function () {
      ...
      /*  if ($("input[name='loanRuleName']").val()== "") {
            msgAlert.text('请输入名称');
            return false;
        }*/
