...
angular.module('MetronicApp').controller('d2pgoodsmanageController', ['$rootScope', '$scope','$http','uiGridConstants', 'settings','d2p','commonUtil','System', function($rootScope, $scope, $http, uiGridConstants,settings, d2p,commonUtil,System) {
    ...
    function initialShow(){
        ...
        function initialShowOne(id){
            vm.showOne = id;
            $http({url:"/d2p/category/queryChildren/"+vm.showOne,method: "post",
                params:{
                }
            }).success(function(data) {
                vm.showOneSelect= '';
        ...
        function initialShowTwo(id){
            ...
            if(vm.showTwo == ''){
                ...
                $http({url:"/d2p/category/queryChildren/"+vm.showTwo,method: "post",
                    params:{
                    }
                }).success(function(data) {
                    vm.showTwoSelect= '';
        ...
        function initialShowThree(id){
            ...
            if(vm.showThree ==''){
                ...
                $http({url:"/d2p/category/queryChildren/"+ vm.showThree,method: "post",
                    params:{
                    }
                }).success(function(data) {
                    vm.showThreeSelect = '';
    ...
    function initialBrand(){
        d2p.queryBrand(vm).success(function(data) {
            if(data.status==00){
    ...
    vm.confirmEdit = function(){
        ...
        if($scope.clickedNode == ''){
            ...
            d2p.setShelveCategory(vm).success(function(data) {
                if(data.status==00){
    ...
    vm.onSale = function(){
        ...
        if(vm.entity.getSelectedRows().length == 0){
            ...
            d2p.doShelve(vm).success(function(data) {
             if(data.status==00){
                 msgAlert.text('上架成功');
    ...
    vm.unSale = function(){
        ...
        if(vm.entity.getSelectedRows().length == 0){
            ...
            d2p.cancelShelve(vm).success(function(data) {
                if(data.status==00){
                    msgAlert.text('下架成功');
                    vm.entity.clearSelectedRows();
                    vm.getPage();
    ...
    vm.modifySale = function(){
        ...
        if(vm.entity.getSelectedRows().length == 0){
            ...
            vm.settingWay = vm.entity.getSelectedRows()[0].priceType;
                ...
                d2p.getNumPriceList(vm).success(function(data) {
                    if(data.status==00){
                       console.log(data)
    ...
    vm.confirmSetPrice = function(){
        if(vm.settingWay == 0 ){
           ...
           console.log(vm.form)
            ...
            $.ajax({
                url:"/d2p/price/setSpecPrice/" + shelvesId,
                data:vm.form,
                type:"post",
                dataType:"json",
                success:function(data){
            ...
            $.ajax({
                url:"/d2p/price/setNumPrice/" + vm.resultMap.shelveId,
                data:vm.form,
                type:"post",
                dataType:"json",
                success:function(data){
