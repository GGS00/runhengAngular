 ...
 * 库位转移
 */
angular.module('MetronicApp').controller('inventoryMvLocControl', ['$rootScope', '$scope', '$http', 'uiGridConstants', 'settings', 'BillManage', 'commonUtil', 'Table', function ($rootScope, $scope, $http, uiGridConstants, settings, BillManage, commonUtil, Table) {
    ...
    vm.pass = function () {
        ...
        BillManage.passMoveDocApply(vm).success(function (data) {
