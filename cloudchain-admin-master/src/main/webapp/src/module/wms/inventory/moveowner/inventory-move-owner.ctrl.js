 ...
 * 货权转移
 */
angular.module('MetronicApp').controller('inventoryMvOwnerControl', ['$rootScope', '$scope','$http','uiGridConstants', 'settings','BillManage','commonUtil','Table', function($rootScope, $scope,$http,uiGridConstants, settings, BillManage,commonUtil,Table) {
    ...
    vm.pass = function () {
        ...
        BillManage.passMoveOwnerApply(vm).success(function(data) {
